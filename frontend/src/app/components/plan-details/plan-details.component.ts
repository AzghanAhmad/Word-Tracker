...
export class PlanDetailsComponent implements OnInit, OnDestroy {
    ...
    // Display Toggle
    activeTab: 'overview' | 'configuration' | 'schedule' | 'progress' = 'overview';
    ...
    calculateStats() {
        ...
        if (cumActualToday >= cumTargetToday) {
            ...
            newExtendedStats.statusColor = '#ef4444'; // Error Red
        } else {
            newExtendedStats.statusLabel = 'Slightly Behind';
            newExtendedStats.statusColor = '#f59e0b'; // Amber/Yellow
        }
     ...
     */
    onTabChange(tab: 'overview' | 'configuration' | 'schedule' | 'progress') {
        this.activeTab = tab;
