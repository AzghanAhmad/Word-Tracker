...
export class ProfileComponent implements OnInit {
    ...
    user = {
        ...
        email: '',
        bio: '',
        avatar_url: '/uploads/avatars/test_avatar.png',
        created_at: '',
        initials: ''
    };
        ...
        this.apiService.getUserProfile().subscribe({
            next: (response) => {
                ...
                if (response.success && response.data) {
                    ...
                    this.user = {
                        ...
                        bio: data.bio || '',
                        avatar_url: data.avatar_url || '/uploads/avatars/test_avatar.png',
            ...
            error: (err) => {
                ...
                this.user = {
                    ...
                    email: localStorage.getItem('email') || 'user@example.com',
                    bio: '',
                    avatar_url: localStorage.getItem('avatar_url') || '/uploads/avatars/test_avatar.png',
                    created_at: new Date().toISOString(),
                    initials: this.getInitials(localStorage.getItem('username') || 'Guest')
                };
                this.memberSince = this.formatMemberSince(new Date().toISOString());
