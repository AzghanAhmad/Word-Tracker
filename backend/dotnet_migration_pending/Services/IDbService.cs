...
public interface IDbService
{
    ...
    int CreateChecklistWithItems(int userId, int? planId, string name, System.Text.Json.JsonElement[]? items, string? activityType = null, string? contentType = null, string? startDate = null, string? endDate = null, string? algorithmType = null);
    string GetChecklistsJson(int userId);
    string? GetChecklistJson(int id, int userId);
    bool UpdateChecklist(int id, int userId, int? planId, string name, System.Text.Json.JsonElement[]? items, string? activityType = null, string? contentType = null, string? startDate = null, string? endDate = null, string? algorithmType = null);
    ...
    bool UpdateChecklistItem(int itemId, bool isDone, string? date = null, string? content = null);
